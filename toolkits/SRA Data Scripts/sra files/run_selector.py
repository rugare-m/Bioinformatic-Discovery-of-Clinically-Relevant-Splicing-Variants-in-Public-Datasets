...
parser = argparse.ArgumentParser(
                    ...
                    description='select runs from a csv file based on a study id list')
...
#need to be tissues list
with open(input_txt, 'r') as f:
    my_list = f.read().splitlines()

#print (my_list)

tissues = ['brain', 'adipose', 'adrenal gland', 
           'aorta', 'blood plasma', 'breast', 
           'cardiac atrium', 'colon', 'left ventricle', 
           'liver', 'lung', 'lymphocyte', 'Oesophagus mucosa', 
           'ovary', 'pancreas', 'prostate gland', 
